    ...
    <>
      <div className="body-wrapper">
        ...
        <>
                ...
                <div className="col-lg-6 align-self-center">
                  <div className="about-us-info-wrap">
                    ...
                    <ul className="ltn__list-item-1 ltn__list-item-1-before--- clearfix">
                      <li>
                        <i className="fas fa-check-square" /> Better security
                        for patient privacy and information.
                      </li>
                      <li>
          ...
          <div
            className="ltn__call-to-action-area section-bg-1 bg-image pt-120 pb-120"
            data-bs-bg="img/bg/25.jpg"
          >
            <div className="container">
              <div className="row">
                <div className="col-lg-7">
                  <div className="call-to-action-inner text-color-white--- text-center---">
                    <div className="section-title-area ltn__section-title-2--- text-center---">
                      ...
                      <p>
                        Cur tantas regiones barbarorum obiit, tot maria
                        transmist <br />
