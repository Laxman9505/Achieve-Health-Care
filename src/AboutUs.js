              ...
              <div className="about-us-info-wrap">
                <div className="section-title-area ltn__section-title-2--- mb-30">
                  ...
                  <p>
                    ...
                    state-of-the-art facilities, we are here to guide, support,
                    and empower you every step of the way.
                  </p>
                </div>
                <ul className="ltn__list-item-1 ltn__list-item-1-before--- clearfix">
                  <li>
                    <i className="fas fa-check-square" /> Comprehensive Surgical
                    Excellence:
                  </li>
                  <li>
            ...
            <div className="col-lg-3 col-sm-6 col-12">
              <div className="ltn__feature-item ltn__feature-item-6 text-center">
                ...
                <div className="ltn__feature-info">
                  ...
                  <p>
                    Your health doesn't adhere to a schedule, and neither do we.
                    Our dedicated 24/7 support team is always ready to assist
                    you, day or night.
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-6 align-self-center">
              <div className="about-us-info-wrap">
                <div className="section-title-area ltn__section-title-2--- mb-30">
                  ...
                  <p>
                    Amid the challenges of Nepal's uncertain times, where people
                    are moving to cities and other countries for jobs and
                    education, the importance of good health is growing. In
                    Nepal, there are about 60 major hospitals that focus on
                    surgeries, especially in cities.
                  </p>

                  <p>
                    We dealt with things like anesthesia products, materials to
                    close wounds, and disposable items. But as we looked ahead,
                    we saw a bigger mission. So, in November 2013, we launched
                    Achieve Health Care. Our main goal was to provide important
                    tools for surgeries, like instruments and equipment, as well
                    as products to close wounds. Our journey started with a
                    strong focus on disposable surgical items, showing our
                    dedication to making healthcare better for everyone.
                  </p>
                  <p>
            ...
            <div className="col-lg-4 col-sm-6 col-12">
              <div className="ltn__feature-item ltn__feature-item-7">
                <div className="ltn__feature-icon-title">
                  ...
                  <h3>
                    <a href="service-details.html">Patient-Centric Approach</a>
                  </h3>
                </div>
                <div className="ltn__feature-info">
                  <p>
                    From pre-operative consultations to post-operative recovery,
                    our patient-centric focus guides every step of your
                    experienc
                  </p>
                </div>
              </div>
            ...
            <div className="col-lg-4 col-sm-6">
              <div className="ltn__team-item ltn__team-item-3--- shadow-sm">
                ...
                <div className="team-info">
                  ...
                  <h6 className="ltn__secondary-color">Bio Medical Engineer</h6>
                  <div className="ltn__social-media">
                    <ul>
                      <li>
                        <a href="index.html">
